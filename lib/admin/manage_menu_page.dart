  ...
  void _initializeDefaultMenuItems() {
    _menuItems.addAll([
      MenuItem(
        title: 'Espresso',
        price: 2.50,
        image: 'assets/images/espresso.png', // Corrected to match the file name
      ),
      MenuItem(
        title: 'Latte',
        price: 3.50,
        image: 'assets/images/latte.png', // Replace with your image file
      ),
      MenuItem(
        title: 'Cappuccino',
        price: 3.00,
        image: 'assets/images/cappuiccino.png', // Replace with your image file
      ),
      MenuItem(
        title: 'Mocha',
        price: 3.75,
        image: 'assets/images/mocha.png', // Replace with your image file
      ),
      MenuItem(
        title: 'Black Coffee',
        price: 2.00,
        image: 'assets/images/americano.png', // Replace with your image file
      ),
    ]);
  }
